...
# in a restart point over the promotion, like in the recovery test
...
# Hold the next restart point on the standby.
$node_b->safe_psql('postgres',
	"SELECT injection_points_attach('create-restart-point', 'wait');");

# Give the restart point a checkpoint record to work on, then start it
