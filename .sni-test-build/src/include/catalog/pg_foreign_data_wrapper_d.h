...
#define Anum_pg_foreign_data_wrapper_fdwconnection 6
#define Anum_pg_foreign_data_wrapper_fdwacl 7
#define Anum_pg_foreign_data_wrapper_fdwoptions 8

#define Natts_pg_foreign_data_wrapper 8
