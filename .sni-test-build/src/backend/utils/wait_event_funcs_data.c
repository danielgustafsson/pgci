 ...
 */
	...
	{"Buffer", "BufferExclusive", "Waiting to acquire an exclusive lock on a buffer"},
	...
	{"LWLock", "DataChecksumTransition", "Waiting for a data checksum state transition to be written to WAL"},
