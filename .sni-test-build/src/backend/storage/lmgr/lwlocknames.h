...
#define WaitLSNLock                      (&MainLWLockArray[54].lock)
#define LogicalDecodingControlLock       (&MainLWLockArray[55].lock)
#define DataChecksumsWorkerLock          (&MainLWLockArray[56].lock)
#define AioWorkerControlLock             (&MainLWLockArray[57].lock)
#define DataChecksumTransitionLock       (&MainLWLockArray[58].lock)

#define NUM_INDIVIDUAL_LWLOCKS		59
