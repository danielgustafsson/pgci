...
#define Anum_pg_publication_rel_prexcept 4
#define Anum_pg_publication_rel_prqual 5
#define Anum_pg_publication_rel_prattrs 6

#define Natts_pg_publication_rel 6
