...
extern Datum binary_upgrade_set_next_toast_chunk_id_typoid(PG_FUNCTION_ARGS);
extern Datum pg_stat_reset_single_index_counters(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_idx_numscans(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_idx_tuples_returned(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_idx_tuples_fetched(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_idx_blocks_fetched(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_idx_blocks_hit(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_idx_lastscan(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_idx_stat_reset_time(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_xact_idx_numscans(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_xact_idx_tuples_returned(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_xact_idx_tuples_fetched(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_xact_idx_blocks_fetched(PG_FUNCTION_ARGS);
extern Datum pg_stat_get_xact_idx_blocks_hit(PG_FUNCTION_ARGS);
