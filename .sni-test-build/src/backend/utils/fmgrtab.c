...
const FmgrBuiltin fmgr_builtins[] = {
  ...
  { 8219, 1, true, false, "binary_upgrade_set_next_toast_chunk_id_typoid", binary_upgrade_set_next_toast_chunk_id_typoid },
  { 8450, 1, true, false, "pg_stat_reset_single_index_counters", pg_stat_reset_single_index_counters },
  { 8451, 1, true, false, "pg_stat_get_idx_numscans", pg_stat_get_idx_numscans },
  { 8452, 1, true, false, "pg_stat_get_idx_tuples_returned", pg_stat_get_idx_tuples_returned },
  { 8453, 1, true, false, "pg_stat_get_idx_tuples_fetched", pg_stat_get_idx_tuples_fetched },
  { 8454, 1, true, false, "pg_stat_get_idx_blocks_fetched", pg_stat_get_idx_blocks_fetched },
  { 8455, 1, true, false, "pg_stat_get_idx_blocks_hit", pg_stat_get_idx_blocks_hit },
  { 8456, 1, true, false, "pg_stat_get_idx_lastscan", pg_stat_get_idx_lastscan },
  { 8457, 1, true, false, "pg_stat_get_idx_stat_reset_time", pg_stat_get_idx_stat_reset_time },
  { 8458, 1, true, false, "pg_stat_get_xact_idx_numscans", pg_stat_get_xact_idx_numscans },
  { 8459, 1, true, false, "pg_stat_get_xact_idx_tuples_returned", pg_stat_get_xact_idx_tuples_returned },
  { 8460, 1, true, false, "pg_stat_get_xact_idx_tuples_fetched", pg_stat_get_xact_idx_tuples_fetched },
  { 8461, 1, true, false, "pg_stat_get_xact_idx_blocks_fetched", pg_stat_get_xact_idx_blocks_fetched },
  { 8462, 1, true, false, "pg_stat_get_xact_idx_blocks_hit", pg_stat_get_xact_idx_blocks_hit },
